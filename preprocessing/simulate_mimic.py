...
var = ['gender', 'age','re_admission', 'Weight_kg', 'GCS', 'HR', 'SysBP', 'MeanBP', 'DiaBP', 'RR', 'SpO2',
        'Temp_C', 'FiO2_1', 'Potassium', 'Sodium', 'Chloride', 'Glucose', 'Creatinine', 'Magnesium', 
        'Total_bili', 'Albumin', 'Hb', 'WBC_count', 'Platelets_count', 'Arterial_pH', 'paO2', 'Arterial_BE', 
        'Arterial_lactate', 'HCO3', 'PaO2_FiO2', 'output_total', 'output_4hourly']
